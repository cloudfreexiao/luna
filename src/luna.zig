...
pub const LunaState = struct {
    ...
    pub fn init(allocator: Allocator) !LunaState {
    ...
    pub fn deinit(L: *LunaState) void {
        L.luna_close();
        if (L.allocator) |a| {
            const allocator = a;
            allocator.destroy(a);
    ...
    pub fn luna_close(L: *LunaState) void {
        c.lua_close(L.state);
    }
    ...
    pub fn luna_call(L: *LunaState, nargs: i32, nresults: i32) void {
    ...
    pub fn luna_checkstack(L: *LunaState, n: i32) bool {
    ...
    pub fn luna_concat(L: *LunaState, n: i32) void {
    ...
    pub fn copy(L: *LunaState, fromidx: i32, toidx: i32) void {
    ...
    pub fn luna_error(L: *LunaState) noreturn {
    ...
    pub fn luna_gc_stop(L: *LunaState) void {
        _ = c.lua_gc(L.state, c.LUA_GCSTOP, 0);
    }

    /// Restarts the garbage collector
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_restart(L: *LunaState) void {
    ...
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_set_generational(L: *LunaState, minor_mul: i32, major_mul: i32) bool {
    ...
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_set_incremental(L: *LunaState, pause: i32, step_mul: i32, step_size: i32) bool {
    ...
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_is_running(L: *LunaState) bool {
        return c.lua_gc(L.state, c.LUA_GCISRUNNING) != 0;
    }

    /// Returns the current amount of memory (in Kbytes) in use by Lua
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_count(L: *LunaState) i32 {
        return c.lua_gc(L.state, c.LUA_GCCOUNT, 0);
    }

    /// Returns the current amount of memory (in Kbytes) in use by Lua
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_countb(L: *LunaState) i32 {
        return c.lua_gc(L.state, c.LUA_GCCOUNTB, 0);
    }

    /// Returns the current amount of memory (in Kbytes) in use by Lua
    /// See https://www.lua.org/manual/5.4/manual.html#lua_gc
    pub fn luna_gc_collect(L: *LunaState) i32 {
    ...
    pub fn luna_getfield(L: *LunaState, index: i32, key: [:0]const u8) LuaType {
    ...
    pub fn luna_getglobal(L: *LunaState, name: [:0]const u8) !LuaType {
    ...
    pub fn luna_geti(lua: *LunaState, index: i32, i: LuaInteger) LuaType {
    ...
    pub fn luna_getiuservalue(L: *LunaState, index: i32, n: i32) !LuaType {
    ...
    pub fn luna_getmetatable(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_gettable(L: *LunaState, index: i32) LuaType {
    ...
    pub fn luna_gettop(L: *LunaState) i32 {
    ...
    pub fn luna_insert(L: *LunaState, index: i32) void {
    ...
    pub fn luna_rotate(L: *LunaState, index: i32, n: i32) void {
    ...
    pub fn luna_isboolean(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_iscfunction(L: *LunaState, index: i32) bool {
        return c.lua_iscfunction(L.state, index) != 0;
    }

    /// See https://www.lua.org/manual/5.4/manual.html#lua_isfunction
    pub fn luna_isfunction(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isinteger(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_islightuserdata(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isnil(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isnumber(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isstring(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_istable(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isthread(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isuserdata(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_isyieldable(L: *LunaState) bool {
    ...
    pub fn luna_len(L: *LunaState, index: i32) void {
    ...
    pub fn luna_createtable(L: *LunaState, narr: i32, nrec: i32) void {
    ...
    pub fn luna_newtable(L: *LunaState) void {
    ...
    pub fn luna_newthread(L: *LunaState) LunaState {
        const state = c.lua_newthread(L.state).?;
        return .{ .state = state };
    }

    pub fn luna_newuserdata(L: *LunaState, comptime T: type) *T {
    ...
    pub fn luna_newuserdatauv(L: *LunaState, comptime T: type, user_values: i32) *T {
    ...
    pub fn luna_next(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_pcall(L: *LunaState, num_args: i32, num_results: i32, msg_handler: i32) !void {
    ...
    pub fn luna_pop(L: *LunaState, n: i32) void {
        L.luna_settop(-n - 1);
    }
    ...
    pub fn luna_pushcfunction(L: *LunaState, c_fn: LuaCFunction) void {
    ...
    pub fn luna_pushcclosure(lua: *LunaState, c_fn: LuaCFunction, n: i32) void {
    ...
    pub fn luna_pushfstring(L: *LunaState, fmt: [:0]const u8, args: anytype) [*:0]const u8 {
    ...
    pub fn luna_pushglobaltable(L: *LunaState) void {
    ...
    pub fn luna_pushinteger(L: *LunaState, n: LuaInteger) void {
        c.lua_pushinteger(L.state, n);
    }

    /// Pushes a light userdata onto the stack
    /// See https://www.lua.org/manual/5.4/manual.html#lua_pushlightuserdata
    pub fn luna_pushlightuserdata(L: *LunaState, ptr: *anyopaque) void {
    ...
    pub fn luna_pushlstring(L: *LunaState, bytes: []const u8) []const u8 {
    ...
    pub fn luna_pushstring(L: *LunaState, str: [:0]const u8) [:0]const u8 {
    ...
    pub fn luna_rawequal(L: *LunaState, index1: i32, index2: i32) bool {
    ...
    pub fn luna_rawget(L: *LunaState, index: i32) LuaType {
    ...
    pub fn luna_rawgeti(L: *LunaState, index: i32, n: LuaInteger) LuaType {
    ...
    /// rawgetp
    pub fn luna_rawgetp(L: *LunaState, index: i32, p: *const anyopaque) LuaType {
    ...
    pub fn luna_rawlen(lua: *LunaState, index: i32) LuaUnsigned {
    ...
    pub fn luna_rawset(L: *LunaState, index: i32) void {
    ...
    pub fn luna_rawseti(lua: *LunaState, index: i32, i: LuaInteger) void {
    ...
    /// Pops the value from the stack. Does not use __newindex metavalue
    /// rawsetp
    pub fn luna_rawsetp(L: *LunaState, index: i32, p: *const anyopaque) void {
        c.lua_rawsetp(L.state, index, p);
    }

    /// Sets the C function f as the new value of global name
    /// See https://www.lua.org/manual/5.4/manual.html#lua_register
    pub fn luna_register(L: *LunaState, name: [:0]const u8, c_fn: LuaCFunction) void {
    ...
    pub fn luna_replace(L: *LunaState, index: i32) void {
        // translate-c cannot translate this macro correctly
    ...
    /// See https://www.lua.org/manual/5.4/manual.html#lua_copy
    pub fn luna_copy(L: *LunaState, from_index: i32, to_index: i32) void {
    ...
    pub fn luna_resetthread(L: *LunaState) !void {
    ...
    pub fn luna_closethread(L: *LunaState, from: ?LunaState) !void {
    ...
    pub fn luna_setfield(L: *LunaState, index: i32, k: [:0]const u8) void {
        c.lua_setfield(L.state, index, k.ptr);
    }

    /// Pops a value from the stack and sets it as the new value of global `name`
    /// See https://www.lua.org/manual/5.4/manual.html#lua_setglobal
    pub fn luna_setglobal(L: *LunaState, name: [:0]const u8) void {
    ...
    pub fn luna_seti(L: *LunaState, index: i32, n: LuaInteger) void {
    ...
    pub fn luna_setiuservalue(L: *LunaState, index: i32, n: i32) !void {
    ...
    pub fn luna_setmetatable(L: *LunaState, index: i32) void {
    ...
    pub fn luna_settable(L: *LunaState, index: i32) void {
    ...
    pub fn luna_stringtonumber(L: *LunaState, str: [:0]const u8) !void {
    ...
    pub fn luna_toboolean(L: *LunaState, index: i32) bool {
    ...
    pub fn luna_tocfunction(L: *LunaState, index: i32) !LuaCFunction {
    ...
    pub fn luna_toclose(L: *LunaState, index: i32) void {
    ...
    pub fn luna_tointeger(L: *LunaState, index: i32) !LuaInteger {
    ...
    pub fn luna_tolstring(L: *LunaState, index: i32) ![:0]const u8 {
    ...
    pub fn luna_tonumber(L: *LunaState, index: i32) !LuaNumber {
        var success: c_int = undefined;
    ...
    pub fn luna_topointer(L: *LunaState, index: i32) !*const anyopaque {
    ...
    pub fn luna_tostring(L: *LunaState, index: i32) ![*:0]const u8 {
        var length: usize = undefined;
    ...
    pub fn luna_tothread(L: *LunaState, index: i32) !LunaState {
        const thread = c.lua_tothread(L.state, index);
        if (thread) |thread_ptr| return LunaState{ .state = thread_ptr };
        return error.Fail;
    }
    ...
    pub fn luna_touserdata(L: *LunaState, comptime T: type, index: i32) !*T {
    ...
    pub fn luna_type(L: *LunaState, index: i32) LuaType {
    ...
    pub fn luna_typename(L: *LunaState, t: LuaType) [:0]const u8 {
    ...
    pub fn luna_upvalueindex(L: *LunaState, i: i32) i32 {
        _ = L;
    ...
    pub fn luna_xmove(from: *LunaState, to: LunaState, num: i32) void {
    ...
    pub fn luna_getinfo(L: *LunaState, options: LuaDebugInfo.Options, info: *LuaDebugInfo) void {
    ...
    pub fn luna_getlocal(L: *LunaState, info: *LuaDebugInfo, n: i32) ![:0]const u8 {
        var ar: LuaDebug = undefined;
        ar.i_ci = @ptrCast(info.private);
    ...
    pub fn luna_getstack(L: *LunaState, level: i32) !LuaDebugInfo {
        var ar: LuaDebug = undefined;
    ...
    pub fn luna_getupvalue(L: *LunaState, func_index: i32, n: i32) ![:0]const u8 {
    ...
    pub fn luna_sethook(L: *LunaState, hook_fn: LuaHook, mask: LuaHookMask, count: i32) void {
    ...
    pub fn luna_setlocal(L: *LunaState, info: *LuaDebugInfo, n: i32) ![:0]const u8 {
        var ar: LuaDebug = undefined;
        ar.i_ci = @ptrCast(info.private);
    ...
    pub fn luna_setupvalue(L: *LunaState, func_index: i32, n: i32) ![:0]const u8 {
    ...
    pub fn luna_upvalueid(L: *LunaState, func_index: i32, n: i32) !*anyopaque {
    ...
    pub fn luna_upvaluejoin(L: *LunaState, func_index1: i32, n1: i32, func_index2: i32, n2: i32) void {
    ...
    pub fn lunaL_argcheck(L: *LunaState, cond: bool, arg: i32, extra_msg: [:0]const u8) void {
        // translate-c failed
    ...
    pub fn lunaL_argerror(L: *LunaState, arg: i32, extra_msg: [*:0]const u8) noreturn {
    ...
    pub fn lunaL_argexpected(L: *LunaState, cond: bool, arg: i32, type_name: [:0]const u8) void {
        // translate-c failed
    ...
    pub fn lunaL_typeerror(L: *LunaState, arg: i32, type_name: [:0]const u8) noreturn {
    ...
    pub fn lunaL_callmeta(L: *LunaState, obj: i32, field: [:0]const u8) !void {
    ...
    pub fn lunaL_checkany(L: *LunaState, arg: i32) void {
    ...
    pub fn lunaL_checkinteger(L: *LunaState, arg: i32) LuaInteger {
    ...
    pub fn lunaL_checklstring(L: *LunaState, arg: i32) [:0]const u8 {
        var length: usize = 0;
    ...
    pub fn lunaL_checknumber(L: *LunaState, arg: i32) LuaNumber {
    ...
    pub fn lunaL_checkoption(L: *LunaState, comptime T: type, arg: i32, default: ?T) T {
        const name = blk: {
    ...
    pub fn lunaL_checkstack(L: *LunaState, size: i32, msg: ?[*:0]const u8) void {
    ...
    pub fn lunaL_checkstring(L: *LunaState, arg: i32) [*:0]const u8 {
    ...
    pub fn lunaL_checktype(L: *LunaState, arg: i32, t: LuaType) void {
    ...
    pub fn lunaL_checkudata(L: *LunaState, comptime T: type, arg: i32, name: [:0]const u8) *T {
    ...
    pub fn lunaL_checkversion(L: *LunaState) void {
    ...
    pub fn lunaL_getmetafield(L: *LunaState, obj: i32, field: [:0]const u8) !LuaType {
    ...
    pub fn lunaL_getmetatable(L: *LunaState, table_name: [:0]const u8) LuaType {
    ...
    pub fn lunaL_len(L: *LunaState, index: i32) LuaInteger {
        return c.luaL_len(L.state, index);
    }

    /// Loads a buffer as a Lua chunk
    /// See https://www.lua.org/manual/5.4/manual.html#luaL_loadbufferx
    pub fn lunaL_loadbufferx(L: *LunaState, buf: []const u8, name: [:0]const u8, mode: LuaMode) !void {
    ...
    pub fn lunaL_loadfilex(lua: *LunaState, file_name: [:0]const u8, mode: LuaMode) !void {
        const mode_str = switch (mode) {
            .binary => "b",
            .text => "t",
            .binary_text => "bt",
    ...
    pub fn lunaL_loadstring(L: *LunaState, str: [:0]const u8) !void {
    ...
    pub fn lunaL_newlib(L: *LunaState, list: []const LuaReg) void {
        // translate-c failure
    ...
    pub fn lunaL_newlibtable(L: *LunaState, list: []const LuaReg) void {
        // translate-c failure
    ...
    pub fn lunaL_setfuncs(L: *LunaState, funcs: []const LuaReg, num_upvalues: i32) void {
    ...
    pub fn lunaL_newmetatable(L: *LunaState, key: [:0]const u8) !void {
    ...
    pub fn lunaL_newstate() !LunaState {
    ...
    pub fn lunaL_openlibs(L: *LunaState) void {
    ...
    pub fn lunaL_optinteger(L: *LunaState, arg: i32, default: LuaInteger) LuaInteger {
    ...
    pub fn lunaL_optlstring(L: *LunaState, arg: i32, default: [:0]const u8) [:0]const u8 {
        var length: usize = 0;
    ...
    pub fn lunaL_optnumber(L: *LunaState, arg: i32, default: LuaNumber) LuaNumber {
    ...
    pub fn lunaL_optstring(L: *LunaState, arg: i32, default: [:0]const u8) [*:0]const u8 {
        // translate-c error
    ...
    pub fn lunaL_pushfail(L: *LunaState) void {
    ...
    pub fn lunaL_ref(L: *LunaState, index: i32) !i32 {
    ...
    pub fn lunaL_requiref(L: *LunaState, mod_name: [:0]const u8, open_fn: LuaCFunction, global: bool) void {
    ...
    pub fn lunaL_setmetatable(L: *LunaState, table_name: [:0]const u8) void {
    ...
    pub fn lunaL_tolstring(L: *LunaState, index: i32) [:0]const u8 {
        var length: usize = undefined;
    ...
    pub fn lunaL_traceback(L: *LunaState, other: *LunaState, msg: [:0]const u8, level: i32) void {
        c.luaL_traceback(L.state, other.state, msg.ptr, level);
    }

    /// Returns the name of the type of the value at the given `index`
    /// See https://www.lua.org/manual/5.4/manual.html#luaL_typename
    pub fn lunaL_typename(L: *LunaState, index: i32) [:0]const u8 {
    ...
    pub fn lunaL_unref(L: *LunaState, index: i32, r: i32) void {
    ...
    pub fn lunaL_where(L: *LunaState, level: i32) void {
...
pub const LunaBuffer = struct {
    ...
    pub fn lunaL_buffinit(buf: *LunaBuffer, L: LunaState) void {
    ...
    pub fn lunaL_buffinitsize(buf: *LunaBuffer, L: LunaState, size: usize) []u8 {
...
pub fn wrap(comptime value: anytype) TypeOfWrap(@TypeOf(value)) {
    ...
    return switch (T) {
        LuaState => LunaState{ .state = value },
